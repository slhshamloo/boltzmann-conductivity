...
class BandStructure:
    ...
    def discretize(self):
        ...
        the energy minus chemical potential function. Then, the surface
        is reconstructed using the screened Poisson method to improve
        the quality of the point cloud. Finally, a marching cubes
        algorithm augmented with RIMLS is used to generate the final
        triangulated surface. After the surface construction, periodic
        boundary conditions are applied to "stitch" the open ends of the
        surface together.
        """
