...
\end{equation}
This is more accurate, but very computationally expensive. There are as many integrals to integrate
...
to a quadrature that is exact for polynomials up to degree 2 is sufficient. For this, the integrals
of the functions
\begin{equation}
...
\begin{empheq}[left=\empheqlbrace]{gather}
    ...
    y_1 = x_2 = \frac{2}{3}.
\end{empheq}
This is the quadrature rule used in the package.
