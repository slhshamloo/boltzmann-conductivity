...
by the Hermicitiy of $\tilde{C}_{ab}$), after applying the inner product, this gives
\begin{equation}
...
\begin{gather}
    ...
    \implies f^i = \sum_{a,j} (M^{-1})^{ij} U^\dagger_{ja} \tilde{f}^a
\end{gather}
As this change of basis is the inverse of $U$,
\begin{equation}
    (U^{-1})^i_a = \sum_j (M^{-1})^{ij} U^\dagger_{ja}.
\end{equation}
