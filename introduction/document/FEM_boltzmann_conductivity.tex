...
\end{equation}
but we like to keep it as a transformation for the vectors, since we can just transform the vectors
...
as the transformation reducing the full space to the unique space. The reason we did not use this
