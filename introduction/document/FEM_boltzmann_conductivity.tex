...
\end{equation}
It might be tempting to assume this is the same equation as before the transformation. The key
point is that $P$ is not invertible, since it is not a square matrix. So,
\begin{equation}
    \qty(P A P^T)^{-1} \neq P A^{-1} P^T.
\end{equation}
