...
the Fermi surface has strong anisotropy, which is the case for cuprates. When the Fermi surface is
roughly isotropic, $C(\vb{k}, \vb{k'})$ does not strongly depend on $\vb{k}$ and, because of charge
conservation,
\begin{equation}
