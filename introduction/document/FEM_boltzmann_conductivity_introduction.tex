...
\begin{gather}
    ...
    S_{ij} = \frac{1}{144}&\left(\frac{1}{4}\sum_{m,n} \alpha_{im} \alpha_{jn}
        ...
        + \sum_{i,j} \alpha_i\alpha_j s^{ij} \right.\\
        &\quad+ \left.\frac{1}{2}\sum_{i,n} \alpha_i\alpha_{jn} s^{in} \delta_{\expval{jn}}
        + \frac{1}{2}\sum_{m, j} \alpha_{im}\alpha_j s^{mj} \delta_{\expval{im}}\right).
    \end{aligned}
\end{gather}
