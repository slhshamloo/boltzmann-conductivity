...
can be stored as
\begin{equation}
    \mqty(a_n & a_0 & \dots & a_{n-1} \\ b_0 & b_1 & \dots & b_n \\ c_1 & c_2 & \dots & c_n & c_0).
\end{equation}
...
missing in that case). This is a banded matrix plus two elemnts in the corners. Usually, the corner
terms are not utilized, but they are important in our case.
